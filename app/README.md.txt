...
A.) Save information to the database
B.) Database change triggers the write function which converts the database into a json file in real time and saves it to the s3 bucket



1.) Ask user for more information during login process
